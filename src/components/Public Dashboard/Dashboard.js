                    ...
                    <Row className="align-middle">
                        <Col lg="6">
                            <div >
                                ...
                                <p>Welcome to Booking.app the web based app that make your live much easier </p>
                    ...
                    <Row className="justify-content-md-center">
                        <Col lg="6">
                            <div className={styles.steps}>
                                ...
                                <p>A few  simple steps to booking a service, see how easy to booking </p>
                            </div>
                        </Col>
                    </Row >
                    <Row className="justify-content-md-center">
                        <Col className={styles.specificStepsWrapper} lg="12">
                            ...
                            <div className={styles.specificSteps}>
                                <div className={styles.step}><FiMapPin></FiMapPin></div>
                                <div className={styles.step}><FiBriefcase></FiBriefcase></div>
                                <div className={styles.step}><FiCalendar></FiCalendar></div>
                                <div className={styles.step}><FiCheckCircle></FiCheckCircle></div>
                            </div>
